    ...
    child: ListView.builder(
        ...
        itemBuilder: (context, index){
          return Container(
            ...
            child: InkWell(
              onTap: () {
                Navigator.of(context).pushNamed(AppRoutes.MY_COURSE_DETAIL, arguments: {
                  // "sectionId":state.sectionItem[index].id,
                  // "courseId": courseId
                  "courseId": state.courseItem[index].id
                });
              },
              child: Row(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image:  DecorationImage(
                                ...
                                image: NetworkImage(state.courseItem[index].image ?? "assets/logo/logo_click_thumb_light.png"))),
